...
typedef struct {
	...
	SDL_Surface	*img;		/* resource image */
	int		img_x_offset;	
	...
	int		frame_id;	/* the integer frame_id (int)frame used to display the 
					   current frame */
	...
	double		alpha;		/* alpha of particle. the old alpha of image is not
					   restored */
